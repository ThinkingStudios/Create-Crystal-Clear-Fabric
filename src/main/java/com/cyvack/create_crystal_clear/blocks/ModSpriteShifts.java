...
public class ModSpriteShifts {
	// Casings
	public static final CTSpriteShiftEntry ANDESITE_GLASS_CASING = omni("andesite_glass_casing"),
	...
	// Clear Glass Casings
	public static final CTSpriteShiftEntry ANDESITE_CLEAR_GLASS_CASING = omni("andesite_clear_glass_casing"),
	...
	public static final CTSpriteShiftEntry STEEL_TINTED_GLASS_CASING = omni("steel_tinted_glass_casing");
	...
	private static CTSpriteShiftEntry getCT(CTType type, String blockTextureName, String connectedTextureName) {
		return CTSpriteShifter.getCT(type, Create_Crystal_Clear.asResource("block/" + blockTextureName),
				Create_Crystal_Clear.asResource("block/" + connectedTextureName + "_connected"));
	}
